...
void createStudent(int socket)
{
    ...
    printf("%s %s, Studiengang: %s, Geb.: %s, Passwort: %s\n",vorname,nachname,studiengang,bday,passwort);
    ...
    char message[MAXDATASIZE];
    sprintf(message,"%s;%s;%s;%s;%s",passwort,vorname,nachname,studiengang,bday);
    sendMsg(socket,message);	
...
char MainMenu(int socket){
    ...
    while(1){
        ...
        switch(option){
            ...
            case 1: system("clear");sendMsg(socket,"1");createStudent(socket);system("clear");return '1';
            case 2: system("clear");sendMsg(socket,"2");findStudent(socket);system("clear");return '2';
            case 3: system("clear");sendMsg(socket,"3");editStudent(socket);system("clear");return '3';
            case 4: system("clear");sendMsg(socket,"4");createGroup(socket);system("clear");return '4';
            case 5: system("clear");sendMsg(socket,"5");findGroup(socket);system("clear");return '5';
            case 6:	system("clear");sendMsg(socket,"6");showGroups(socket);system("clear");return '6';
            case 7: system("clear");sendMsg(socket,"7");addMark(socket);system("clear");return '7';
            case 8: system("clear");sendMsg(socket,"8");groupsBest(socket);system("clear");return '8';
            case 9: system("clear");sendMsg(socket,"9");bestOfAll(socket);system("clear");return '9';
...
char SMenu(int socket, char* mNr){
    ...
    while(1){
        scanf("%i",&option);
        switch(option){
            case 0: system("clear");showSMenu();system("clear");break;
            case 1: system("clear");sendMsg(socket,"11");getSData(socket,mNr);system("clear");return; 
